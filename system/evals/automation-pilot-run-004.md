# Automation Pilot — Run 004

**Purpose:** Official run-specific record for `m6-2-run-004`. All three stages must be complete before this run counts toward the pilot verdict.
...
| Earlier retained invocation disposition | Non-counted preparation attempt; incomplete evidence at `/tmp/m6-2-run-004-evidence/` |
| Evidence-harness preparation attempt | none |
| Fresh official invocation required | yes |
| Official evidence directory | `/tmp/m6-2-run-004-official-evidence/` |

The rejected original draft is preserved at `/tmp/m6-2-original-drafts-2026-08-03/automation-pilot-run-004.md`.
...
Exact command evidence: `/tmp/m6-2-run-004-official-evidence/command.txt`.

### Command result and timestamps

| Field | Value |
|---|---|
| Start UTC | `2026-08-03T17:55:13.794Z` |
| Start Europe/Lisbon | `2026-08-03T18:55:13+0100` |
| End UTC | `2026-08-03T17:55:14.202Z` |
| End Europe/Lisbon | `2026-08-03T18:55:14+0100` |
| Exit code | `0` |
| Stdout | `/tmp/m6-2-run-004-official-evidence/stdout.json` |
| Stderr | `/tmp/m6-2-run-004-official-evidence/stderr.txt` — empty |
...
| Source content evidence | `/tmp/m6-2-run-004-official-evidence/source-content.md` |
...
Snapshot files: `mind-pre-*`, `mind-post-*`, `brain-pre-*`, `brain-post-*`, `protected-pre.tsv`, and `protected-post.tsv` in `/tmp/m6-2-run-004-official-evidence/`.

### Timing

| Field | Value |
|---|---|
| Retrieval elapsed seconds | `0.309` — CLI retrieval stage only |
| Stage 2 ready UTC | `2026-08-03T17:55:51.641Z` |
| Stage 2 ready Europe/Lisbon | `2026-08-03T18:55:51+0100` |
| Observed elapsed seconds | `37.743` — full operator-trigger-to-Stage-2-ready interval |
...
**Complete Stage 2 brief evidence:** `/tmp/m6-2-run-004-official-evidence/stage2-brief.md`
