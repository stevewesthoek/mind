...
**Status:** Batch 8D external Brain workflow validation planning completed 2026-07-09. See `system/reports/external-brain-workflow-validation-plan-2026-07-09.md`, Brain report at `brain/operations/reports/mind-inbox-external-workflow-validation-plan-2026-07-09.md` (Brain commit `50d46df8`), `system/reports/controlled-brain-reader-validation-2026-07-09.md`, `system/reports/inbox-migration-save-to-mind-precheck-2026-07-08.md`, `system/reports/brain-reader-routing-compatibility-precheck-2026-07-08.md`, and this plan. Batch 8D inspected the external `brain` repo and found: (a) the TypeScript code already supports dual-path reading (`inbox/new/` first, `capture/inbox/` fallback); (b) two shell scripts hardcode `capture/inbox` and must be updated; (c) the n8n workflow hardcodes `capture/inbox/` and `capture/failed/` in JavaScript and must be updated to use env-var-driven path prefixes. No Brain implementation code was changed. The next step is Batch 8E — Brain shell script and n8n path update.
